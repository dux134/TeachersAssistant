...
public class StudentViewNotes extends AppCompatActivity {
    ...
    private final String folder = "Teacher Assistant/Notes";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(StudentViewNotes.this, StudentDashboard.class));
        finish();
    }
    ...
    private void onClickAction(View view, final int i) {
        new DownloadFileFromURL(i).execute(manageNotesList.get(i).getFileUrl());
    }
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            /* if specified not exist create new */
                ...
                String fname = manageNotesList.get(index).getFileName();
